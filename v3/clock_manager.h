...
public:
    ...
    // Schedules an immediate forced resync on the next update() call
    // (e.g. right after Wi-Fi comes back from a disconnect), instead
    // of waiting for the normal hourly schedule.
    void forceResyncSoon();
